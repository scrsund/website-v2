  ...
  state() {
    return {
      ...
      projects: [{
        ...
        description: "Website V1 was the first iteration of this website. I put a bigger emphasis on features and functionality, but decided that a simplistic design would be better for a portfolio appeal, which led me to create V2. <br><br>The main difference between the two websites is the use of Vue-Router, Vuex state management, media queries, and unique components customized to each website's design. A contact form using Express.js and PostgreSQL was also implemented in V1.",
